// BLUE DOME — Translations (EN / FR / AR)
const I18N = {
  en: {
    dir: "ltr",
    brand: "BLUE DOME",
  ...
  fr: {
    ...
    week: "Semaine", day: "Jour", month: "Mois", today: "Aujourd'hui",
  ...
  ar: {
    ...
    week: "أسبوع", day: "يوم", month: "شهر", today: "اليوم",
    new_rx: "وصفة جديدة",
    medication: "الدواء",
    dosage: "الجرعة",
    frequency: "التكرار",
    ...
    monday: "اثن", tuesday: "ثلا", wednesday: "أرب", thursday: "خمي", friday: "جمع", saturday: "سبت", sunday: "أحد",
  }
};
