...
class UpdatePatientRequest extends FormRequest
{
    public function authorize(): bool
    {
        ...
        return $this->user()?->can('update', $patient instanceof Patient ? $patient : Patient::class) ?? false;
    }
    ...
    {
        $patient = $this->route('patient');
        $clinicId = $patient instanceof Patient ? $patient->clinic_id : $this->user()->clinic_id;
        $ignoreId = $patient instanceof Patient ? $patient->id : null;
